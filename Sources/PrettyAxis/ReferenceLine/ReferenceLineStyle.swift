...
public struct ReferenceLineStyle{
    ...
    public init<S>(axisColor: S, axisWidth: CGFloat = 1, axisLabelColor: Color = Color.init(red: 174 / 255.0, green: 174 / 255.0, blue:  178 / 255.0), xAxisLabelFont: Font = Font.system(size: 12, weight: .bold), yAxisLabelFont: Font = Font.system(size: 8), formatter: NumberFormatter = .int) where S: ShapeStyle{
